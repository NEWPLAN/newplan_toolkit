...
#ifndef NEWPLAN_TOOLKIT_CORE_PLATFORM_MACROS_H_
#define NEWPLAN_TOOLKIT_CORE_PLATFORM_MACROS_H_
...
#define TF_UNUSED_VARIABLE(x) \
    newplan_toolkit::internal::remove_unused_variable_compiler_warning(x)

#endif // NEWPLAN_TOOLKIT_CORE_PLATFORM_MACROS_H_
